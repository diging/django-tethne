# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-05-18 22:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zip', models.TextField(null=True)),
                ('country', models.TextField(null=True)),
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='institution_name', to='django-tethne.Institution')),
            ],
        ),
        migrations.CreateModel(
            name='Paper',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('source_name', models.CharField(choices=[(b'JSTOR', b'Jstor'), (b'WOS', b'World of Science'), (b'ZOTERO', b'Zotero'), (b'SCOPUS', b'Scopus')], max_length=35, null=True)),
            ],
        ),
        migrations.AddField(
