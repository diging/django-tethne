# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-07-18 12:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abstract', models.TextField(null=True)),
                ('concrete', models.BooleanField(default=True)),
                ('cited_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cited_references', to='tethneweb.PaperInstance')),
                ('corpus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tethneweb.Corpus')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='paperidentity',
            name='instance',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='identities', to='tethneweb.PaperInstance'),
        ),
        migrations.AddField(
            model_name='paperidentity',
            name='model',
        ...
        migrations.AddField(
            ...
            name='paper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='institutions', to='tethneweb.PaperInstance'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='instancemetadatum',
            name='paper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='metadata', to='tethneweb.PaperInstance'),
        ),
        migrations.AddField(
            model_name='instanceidentifier',
            name='paper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='identifiers', to='tethneweb.PaperInstance'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='authorinstance',
            name='paper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author_instances', to='tethneweb.PaperInstance'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='affiliationinstance',
            name='paper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='affiliations', to='tethneweb.PaperInstance'),
        ),
        migrations.AddField(
